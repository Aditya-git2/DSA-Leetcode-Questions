class Solution {
public:
    vector<int>dp;   //globally declared
...
//  Approach 2 => best to do => Top down dp
// class Solution {
// public:
//     vector<int>dp;   //globally declared
...
//         if(dp[i] != -1) return dp[i];    // i th state already computed

//         //if dp[i] was -1 let's compute i th state for first time
...
// Approach 1 => recursive solution => Memory Limit Exceeded
// class Solution {
// public:
//     // helper function
